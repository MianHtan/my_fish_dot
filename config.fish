...
set -gx PATH /home/lab1/packages/TensorRT-8.5.1.7/bin $PATH
set -gx PATH /usr/local/lib/pkgconfig $PATH

set -gx LD_LIBRARY_PATH /home/lab1/packages/TensorRT-8.5.1.7/lib $LD_LIBRARY_PATH
